...
$(window).load(function () {
    ...
    parse_layers_json = function (data_) {
        ...
        // info_popup is the content of the dialog box of the popup window used for the overview portal
        $("#info_popup").dialog({
            closeOnEscape: true,
            //height: 170,
            //minHeight: 400,
        ...
        showInfo = function (evt, infoHTML) {
            ...
            if (evt.features && evt.features.length) {
                ...
                // TODO AA (DOUBLE CHECK) Not sure the reason why the infoPopup should be empty
                infoPopup.empty();
